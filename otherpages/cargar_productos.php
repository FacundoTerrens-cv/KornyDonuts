...
<?php
require_once ('login&register/conection.php');
$QueryComentarios      = ("SELECT * FROM products ORDER BY id DESC LIMIT 5");
...
<div class="row border_special item-comentario">
    <div class="col-md-2 col-sm-12">
         <div id="imgperfil">
            <img src="<?php echo $dataComentarios['image'];?>" alt="">
        </div>
    </div> 

    <div class="col-md-10 text-center marb-35">
        <div class="contenidouser">
            <h4><?php echo $dataComentarios['name'];?></h4>
            <p><?php echo $dataComentarios['description'];?></p>
            <span><?php echo $dataComentarios['price'];?></span>
        </div>
    </div> 
